package apeclient.mods.impl.quickplay;
...
import apeclient.gui.hud.HUDConfigScreen;
import apeclient.gui.hud.HUDManager;
import apeclient.mods.impl.quickplay.ArcadeQuickPlay;
import apeclient.mods.impl.quickplay.BedwarsQuickPlay;
import apeclient.mods.impl.quickplay.BlitzSGQuickPlay;
import apeclient.mods.impl.quickplay.BuildBattleQuickPlay;
import apeclient.mods.impl.quickplay.ClassicGamesQuickPlay;
import apeclient.mods.impl.quickplay.CopsAndCrimsQuickPlay;
import apeclient.mods.impl.quickplay.DuelsQuickPlay;
import apeclient.mods.impl.quickplay.MegaWallsQuickPlay;
import apeclient.mods.impl.quickplay.MurderMysteryQuickPlay;
import apeclient.mods.impl.quickplay.SkywarsQuickPlay;
import apeclient.mods.impl.quickplay.SmashHeroesQuickPlay;
import apeclient.mods.impl.quickplay.TNTQuickPlay;
import apeclient.mods.impl.quickplay.UHCQuickPlay;
import apeclient.mods.impl.quickplay.WarlordsQuickPlay;
...
public class ModQuickPlay extends GuiScreen {
	...
	public void initGui() {
		...
		this.buttonList
				.add(new TransparentButton(10001, this.width / 2 - 460, j + 40 + 10, 60, 50, I18n.format("", new Object[0]))); // Main
																														// Lobby
		this.buttonList
				.add(new TransparentButton(10002, this.width / 2 - 460, j + 40 + 76, 60, 50, I18n.format("", new Object[0]))); // Build
																														// Battle
		this.buttonList
				.add(new TransparentButton(10003, this.width / 2 - 460, j + 40 + 143, 60, 50, I18n.format("", new Object[0]))); // Housing
		this.buttonList
				.add(new TransparentButton(10004, this.width / 2 - 460, j + 40 + 207, 60, 50, I18n.format("", new Object[0]))); // Skyblock
		this.buttonList
				.add(new TransparentButton(10005, this.width / 2 - 460, j + 40 + 270, 60, 50, I18n.format("", new Object[0]))); // TNT

		// ------------------------------------------------------------------------------------------------------------------

		this.buttonList
				.add(new TransparentButton(10006, this.width / 2 - 230, j + 40 + 10, 60, 50, I18n.format("", new Object[0]))); // Arcade
		this.buttonList
				.add(new TransparentButton(10007, this.width / 2 - 230, j + 40 + 76, 60, 50, I18n.format("", new Object[0]))); // Classic
																														// Lobby
		this.buttonList
				.add(new TransparentButton(10008, this.width / 2 - 230, j + 40 + 143, 60, 50, I18n.format("", new Object[0]))); // Mega
																														// Walls
		this.buttonList
				.add(new TransparentButton(10009, this.width / 2 - 230, j + 40 + 207, 60, 50, I18n.format("", new Object[0]))); // SkyWars
		this.buttonList
				.add(new TransparentButton(10010, this.width / 2 - 230, j + 40 + 270, 60, 50, I18n.format("", new Object[0]))); // UHC
																														// Champions

		// ------------------------------------------------------------------------------------------------------------------

		this.buttonList
				.add(new TransparentButton(10011, this.width / 2 - 3, j + 40 + 10, 60, 50, I18n.format("", new Object[0]))); // Bedwars
		this.buttonList
				.add(new TransparentButton(10012, this.width / 2 - 3, j + 40 + 76, 60, 50, I18n.format("", new Object[0]))); // Cops
																														// And
																														  // Crims
		this.buttonList
				.add(new TransparentButton(10013, this.width / 2 - 3, j + 40 + 143, 60, 50, I18n.format("", new Object[0]))); // Murder
																														// Mystery
		this.buttonList
				.add(new TransparentButton(10014, this.width / 2 - 3, j + 40 + 207, 60, 50, I18n.format("", new Object[0]))); // Smash
																														// Heroes
		this.buttonList
				.add(new TransparentButton(10015, this.width / 2 - 3, j + 40 + 270, 60, 50, I18n.format("", new Object[0]))); // Warlords

		// ------------------------------------------------------------------------------------------------------------------

		this.buttonList
				.add(new TransparentButton(10016, this.width / 2 + 150, j + 40 + 10, 60, 50, I18n.format("", new Object[0]))); // Blitz
																														// SG
		this.buttonList
				.add(new TransparentButton(10017, this.width / 2 + 150, j + 40 + 76, 60, 50, I18n.format("", new Object[0]))); // Duels
		this.buttonList
				.add(new TransparentButton(10018, this.width / 2 + 150, j + 40 + 143, 60, 50, I18n.format("", new Object[0]))); // Prototype
		this.buttonList
				.add(new TransparentButton(10019, this.width / 2 + 150, j + 40 + 207, 60, 50, I18n.format("", new Object[0]))); // The
																														// Pit
	}
