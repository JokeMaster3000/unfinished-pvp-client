...
import apeclient.util.AnimatedResourceLocation;
...
public class SplashProgress {
	...
	//private static AnimatedResourceLocation splash;
	...
	public static void drawSplash(TextureManager tm) {
		...
		if(splash == null) {
			//splash = new AnimatedResourceLocation("apeclient/splash", 3, 1);
			splash = new ResourceLocation("apeclient/splash.png");
		}
		
		tm.bindTexture(splash);
		//tm.getTextureanimated(splash);
